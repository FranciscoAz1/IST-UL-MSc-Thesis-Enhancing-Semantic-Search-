...
In \Cref{chap:systemarch}, the overall system architecture is detailed, outlining how document processing, schema design, and retrieval components are integrated into a unified solution.
