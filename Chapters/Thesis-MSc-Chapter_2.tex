...
The Transformer architecture has had a transformative impact on \gls{NLP} . It serves as the basis for \glsxtrfull{LLM} models such as BERT, GPT and others, which are based on the core principles of self-attention and scalability.
