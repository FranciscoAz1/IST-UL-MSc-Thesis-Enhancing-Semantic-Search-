...
% Text symbols (e.g., \textminus used in Chapter 5)
\usepackage{textcomp}
...
\usepackage{tikz}
\usetikzlibrary{shapes.geometric, arrows, positioning,fit,shapes.multipart,arrows.meta}
\tikzset{
  class/.style = {draw, rounded corners, minimum width=22mm, minimum height=7mm, align=center},
  ref/.style   = {-{Latex}, line width=0.9pt},
  lab/.style   = {midway, fill=white, inner sep=1pt, font=\scriptsize},
  note/.style  = {draw, dashed, rounded corners, inner sep=2pt, font=\scriptsize, align=left}
}
% -----------------------------------------------------------------------------
...
%
% -----------------------------------------------------------------------------
% PACKAGE microtype (improves hyphenation and protrusion; reduces over/underfull boxes)
% -----------------------------------------------------------------------------
\usepackage{microtype}

% Improve URL breaking: load hyperref with url option tweaks and use xurl for flexible breaks
% -----------------------------------------------------------------------------
% Ensure hyperref sees hyphen handling options for URLs
\PassOptionsToPackage{hyphens}{url}
\usepackage{hyperref}
% Use xurl to allow line breaks at more characters in \url and \href
\usepackage{xurl}
...
%
% (Retain url package if needed by other packages; xurl supersedes it for breaking.)
%\usepackage{url}

% Provide gentle global fallback to avoid overfull lines without harming layout
% -----------------------------------------------------------------------------
